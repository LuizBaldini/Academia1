...
{
    /// <inheritdoc />
    public partial class newacademia : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreinoExercicio", x => new { x.ExerciciosExercicioID, x.TreinosTreinoID });
                    table.ForeignKey(
                        name: "FK_TreinoExercicio_Exercicios_ExerciciosExercicioID",
                        column: x => x.ExerciciosExercicioID,
                        principalTable: "Exercicios",
                        principalColumn: "ExercicioID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreinoExercicio_Treinos_TreinosTreinoID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreinoExercicio_TreinosTreinoID",
